    ...
    return (
        <footer className="bg-black border-t border-white/10">
            ...
            <div className="border-b border-white/10 py-16 px-6 text-center">
                <p className="text-gray-500 text-xs uppercase tracking-[0.3em] mb-4">Open to opportunities</p>
            ...
            <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
                <p className="text-white font-bold text-lg">Rezdika<span className="text-gray-600">.</span></p>

                <ul className="flex flex-wrap justify-center gap-6">
                    {navLinks.map(l => (
                        <li key={l.href}>
                            <a href={l.href} className="text-gray-600 hover:text-white text-xs transition-colors">
                                {l.label}
                            </a>
                        </li>
                    ))}
            ...
            <div className="text-center pb-6">
                <p className="text-gray-700 text-xs">
                    © {new Date().getFullYear()} Rezdika Akbar. Built with Laravel & React.
                </p>
            </div>
        </footer>
    );
